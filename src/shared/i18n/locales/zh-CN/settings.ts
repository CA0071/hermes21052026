export default {
  ...
  resetInstall: "清理 Yat 安装状态",
  resettingInstall: "正在清理...",
  resetInstallDone: "已清理安装状态，正在重新打开首次安装流程。",
  resetInstallFailed: "清理失败",
  resetInstallConfirm: "这会删除 ~/.hermes 中的 Yat/Hermes 本地运行环境、配置、会话和 API Key，用于模拟全新安装。确定继续？",
  resetInstallHint: "macOS 卸载 App 通常只删除 /Applications/Yat.app，不会自动删除 {{path}}。如果要像新机器一样重装，可先点这里清理本地运行环境。",
  refresh: "刷新",
  emptyLog: "(空)",
  updating: "更新中...",
  updateEngine: "更新引擎",
