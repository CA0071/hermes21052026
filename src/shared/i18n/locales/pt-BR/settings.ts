export default {
  ...
  cliCommandHint:
    "Apenas nome do comando ou caminho completo. O comando codex usa o adaptador Codex; outros comandos recebem o prompt por stdin e retornam stdout.",
  networkSection: "Rede",
  ...
  localCliHint:
    "Executa uma CLI de IA local com seu proprio login e configuracao. Nao requer Chave da API do Hermes nem Base URL.",
  modelHint:
    "Nome do modelo padrão (deixe em branco para usar o padrão do provedor)",
  localCliModelHint:
    "Modelo opcional passado para presets de CLI que aceitam selecao de modelo. Deixe em branco para usar o padrao da CLI.",
