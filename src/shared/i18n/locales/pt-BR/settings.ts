export default {
  ...
  sections: {
    ...
    providerSignIns: "Logins de Provedores",
  ...
  saved: "Salvo",
  providerHint:
    "Selecione um provedor de inferencia ou detecte automaticamente pela autenticacao configurada",
  customProviderHint:
  ...
  providerSignInsHint:
    "Gerencie provedores que usam login no navegador em vez de chaves de API.",
  providerAuthChecking: "Verificando...",
  providerAuthSignedIn: "Conectado",
  providerAuthNotSignedIn: "Nao conectado",
  overviewInstall: "Instalação",
  statusChecking: "Verificando...",
  statusReady: "Pronto",
  statusVerified: "Verificado",
  statusNeedsRepair: "Precisa de reparo",
  statusNeedsSetup: "Precisa de configuração",
  statusNotInstalled: "Não instalado",
  statusUpdateAvailable: "Atualização disponível",
  statusActive: "Ativo",
