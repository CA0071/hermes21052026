export default {
  ...
  saved: "Salvo",
  providerHint: "Selecione um provedor de inferencia ou detecte automaticamente pela autenticacao configurada",
  ...
  providerSignInsHint: "Gerencie provedores que usam login no navegador em vez de chaves de API.",
