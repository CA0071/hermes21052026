export default {
  title: "Memory",
  subtitle:
    "What Erzy remembers about you and your environment across sessions.",
  sessions: "Sessions",
  messages: "Messages",
  memories: "Memories",
  ...
  noMemoriesYet: "No memories yet. Erzy will save important facts as you chat.",
  ...
  userProfileHint: "Tell Erzy about yourself — name, role, preferences, communication style.",
  providersHint: "Pluggable memory providers give Erzy advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",
