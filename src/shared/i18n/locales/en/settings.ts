export default {
  ...
  resetInstall: "Clear Yat install state",
  ...
  resetInstallConfirm: "This deletes the local Yat/Hermes runtime, config, sessions, and API keys under ~/.hermes so you can simulate a fresh install. Continue?",
  resetInstallHint: "macOS app removal usually deletes only /Applications/Yat.app, not {{path}}. To test like a new machine, clear the local runtime here first.",
  refresh: "Refresh",
  emptyLog: "(empty)",
  updating: "Updating...",
