export default {
  ...
  poolHint: "Add multiple API Keys for the same provider for automatic rotation and load balancing. Erzy will cycle through them.",
  add: "Add",
  remove: "Remove",
  keyLabel: "Key",
  empty: "(empty)",
  dataSection: "Data",
  dataHint: "Export or import your Erzy Office configuration, sessions, skills, and memory.",
  ...
  migrationDesc: "Found OpenClaw at <code>{{path}}</code>. You can migrate your configuration, API keys, sessions, and skills to Erzy Office.",
  migrationDismiss: "Don't show again",
  migrating: "Migrating...",
  migrateToHermes: "Migrate to Erzy Office",
  skip: "Skip",
  ...
  modeLocal: "Local",
  modeRemote: "Remote",
  modeLocalHint: "Using Erzy Office installed on this device",
  modeRemoteHint: "Connect to an Erzy Office API server on your network or cloud",
  remoteUrl: "Remote URL",
  remoteUrlHint: "The Erzy Office API server URL (must expose /health and /v1/chat/completions)",
  ...
  serverConfigHint: "You&apos;re connected to a remote Erzy Office server. Model selection, provider API keys, and credentials are managed on the server&apos;s <code>~/.hermes/.env</code> and <code>config.yaml</code> files. Edit them on the host (e.g. <code>docker exec -it erzy-office vi /opt/data/.env</code>) and restart the container.",
  connectionMode: "Mode",
