export default {
  ...
  localCliModelPlaceholder: "Optional model name",
  cliCommand: "CLI Command",
  cliCommandPlaceholder: "codex",
  cliCommandHint:
    "Command name or full path only. The codex command uses the Codex adapter; other commands receive the prompt on stdin and return stdout.",
  ...
  localCliHint:
    "Runs a local AI CLI with its own login and config. No Hermes API key or Base URL is required.",
  modelHint: "Default model name (leave blank to use provider default)",
  localCliModelHint:
    "Optional model passed to CLI presets that support model selection. Leave blank to use the CLI default.",
