export default {
  ...
  saved: "Saved",
  providerHint:
    "Select an inference provider, or auto-detect from configured auth",
  customProviderHint:
  ...
  providerSignInsHint:
    "Manage providers that use browser sign-in instead of API keys.",
  providerAuthChecking: "Checking...",
  providerAuthSignedIn: "Signed in",
  providerAuthNotSignedIn: "Not signed in",
  overviewInstall: "Install",
